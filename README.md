# [Adminator](https://appseed.us/generator/adminator/) Flask

Open-source **Flask Dashboard** generated by `AppSeed` op top of an iconic design. For newcomers, **[Adminator](https://appseed.us/generator/adminator/)** is one of the best open-source admin dashboard & control panel theme. Built on top of Bootstrap, `Adminator` provides a range of responsive, reusable, and commonly used components. 
...
- Timestamp: `2022-07-04 13:14`
- Build ID: `1b002a19-420c-4947-bc07-679db6377c7e`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/1b002a19-420c-4947-bc07-679db6377c7e.git
$ cd 1b002a19-420c-4947-bc07-679db6377c7e
```
...
---
[Adminator](https://appseed.us/generator/adminator/) Flask - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
